...
const features: NavBarProps[] = [
  ...
  {
    feature:
      'No database, backend or server side code is required. Everything is taken care by GetLost',
    children: <Server />,
  },
  {
    feature:
  ...
  {
    feature:
      'The quickest way to set up password login page, hosted on GetLost',
    children: <Shield />,
  },
  {
    feature:
